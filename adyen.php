 ...
 */
function adyen_civicrm_xmlMenu(&$files) {
  _adyen_civix_civicrm_xmlMenu($files);
}
 ...
 */
function adyen_civicrm_managed(&$entities) {
  _adyen_civix_civicrm_managed($entities);
}
 ...
 */
function adyen_civicrm_caseTypes(&$caseTypes) {
  _adyen_civix_civicrm_caseTypes($caseTypes);
}
 ...
 */
function adyen_civicrm_angularModules(&$angularModules) {
  _adyen_civix_civicrm_angularModules($angularModules);
}
 ...
 */
function adyen_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
  _adyen_civix_civicrm_alterSettingsFolders($metaDataFolders);
}
 ...
 */
function adyen_civicrm_themes(&$themes) {
  _adyen_civix_civicrm_themes($themes);
}
